  ...
  <div className="mt-10">
    {links.map((item) => (
      <NavLink
        key={item.name}
        to={item.to}
        className="flex flow-row justify-start items-center my-8 text-sm font-medium text-gray-400 hover:text-cyan-400"
      >
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#191824]">
